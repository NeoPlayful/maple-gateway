...
func New(d Deps) *fiber.App {
	...
	if d.CMClient != nil {
		...
		cg.Delete("/instances/:id", cmH.RemoveInstance)
		...
		cg.Get("/tasks", cmH.Tasks)
		cg.Get("/tasks/:id", cmH.TaskDetail)
		cg.Post("/tasks/:id/retry", cmH.RetryTask)
		cg.Post("/tasks/:id/cancel", cmH.CancelTask)
		cg.Get("/applications", cmH.Applications)
		cg.Post("/applications", cmH.SaveApplication)
		cg.Get("/applications/:id", cmH.ApplicationDetail)
