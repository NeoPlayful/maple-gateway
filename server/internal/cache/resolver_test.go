...
func newStickyVersionedCache(t *testing.T) *Cache {
	...
	c := New(tenant.NewRepository((*ent.Client)(nil)), domain.NewRepository((*ent.Client)(nil)), service.NewRepository((*ent.Client)(nil)), instance.NewRepository((*ent.Client)(nil)))
	c.mu.Lock()
	c.table = table
	c.mu.Unlock()
	return c
