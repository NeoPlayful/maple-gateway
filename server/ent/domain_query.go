...
func (dq *DomainQuery) QueryTenant() *TenantQuery {
...
func (dq *DomainQuery) IDs(ctx context.Context) (ids []uuid.UUID, err error) {
...
func (dq *DomainQuery) WithTenant(opts ...func(*TenantQuery)) *DomainQuery {
	query := (&TenantClient{config: dq.config}).Query()
...
func (dq *DomainQuery) loadTenant(ctx context.Context, query *TenantQuery, nodes []*Domain, init func(*Domain), assign func(*Domain, *Tenant)) error {
