...
func (au *AdminUpdate) SetNillableStatus(s *string) *AdminUpdate {
	if s != nil {
		au.SetStatus(*s)
	}
	return au
...
func (au *AdminUpdate) SetNillableUpdatedAt(t *time.Time) *AdminUpdate {
	if t != nil {
		au.SetUpdatedAt(*t)
	}
	return au
...
// SetStatus sets the "status" field.
func (auo *AdminUpdateOne) SetStatus(s string) *AdminUpdateOne {
	auo.mutation.SetStatus(s)
	return auo
}

// SetNillableStatus sets the "status" field if the given value is not nil.
func (auo *AdminUpdateOne) SetNillableStatus(s *string) *AdminUpdateOne {
	if s != nil {
		auo.SetStatus(*s)
	}
	return auo
...
// SetNillableUpdatedAt sets the "updated_at" field if the given value is not nil.
func (auo *AdminUpdateOne) SetNillableUpdatedAt(t *time.Time) *AdminUpdateOne {
	if t != nil {
		auo.SetUpdatedAt(*t)
	}
	return auo
