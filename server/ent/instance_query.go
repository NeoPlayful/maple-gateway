...
func (iq *InstanceQuery) QueryService() *ServiceQuery {
...
func (iq *InstanceQuery) WithService(opts ...func(*ServiceQuery)) *InstanceQuery {
	query := (&ServiceClient{config: iq.config}).Query()
...
//		GroupBy(instance.FieldServiceID).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.Instance.Query().
//		Select(instance.FieldServiceID).
//		Scan(ctx, &v)
...
func (iq *InstanceQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Instance, error) {
	...
	if query := iq.withService; query != nil {
		if err := iq.loadService(ctx, query, nodes, nil,
			func(n *Instance, e *Service) { n.Edges.Service = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (iq *InstanceQuery) loadService(ctx context.Context, query *ServiceQuery, nodes []*Instance, init func(*Instance), assign func(*Instance, *Service)) error {
...
func (iq *InstanceQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := iq.ctx.Fields; len(fields) > 0 {
		...
		if iq.withService != nil {
			_spec.Node.AddColumnOnce(instance.FieldServiceID)
		}
	}
