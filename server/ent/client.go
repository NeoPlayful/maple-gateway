...
func (c *Client) Use(hooks ...Hook) {
	for _, n := range []interface{ Use(...Hook) }{
		c.AuditLog, c.BluegreenDeployment, c.BluegreenEvent, c.CanaryEvent,
...
type (
	hooks struct {
		AuditLog, BluegreenDeployment, BluegreenEvent, CanaryEvent, CanaryRelease,
		Deployment, DeploymentVersion, Domain, Instance, Node, RateLimit, Service,
		Setting, Tenant, TrafficPolicy []ent.Hook
	}
	inters struct {
		AuditLog, BluegreenDeployment, BluegreenEvent, CanaryEvent, CanaryRelease,
		Deployment, DeploymentVersion, Domain, Instance, Node, RateLimit, Service,
		Setting, Tenant, TrafficPolicy []ent.Interceptor
	}
)
