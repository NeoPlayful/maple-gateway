...
func (rq *ReleaseQuery) IDs(ctx context.Context) (ids []uuid.UUID, err error) {
...
func (rq *ReleaseQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(release.Table, release.Columns, sqlgraph.NewFieldSpec(release.FieldID, field.TypeUUID))
	_spec.From = rq.sql
