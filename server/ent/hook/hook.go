...
// The DeploymentVersionFunc type is an adapter to allow the use of ordinary
// function as DeploymentVersion mutator.
type DeploymentVersionFunc func(context.Context, *ent.DeploymentVersionMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f DeploymentVersionFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.DeploymentVersionMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.DeploymentVersionMutation", m)
}
...
// Mutate calls f(ctx, m).
func (f RateLimitFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.RateLimitMutation); ok {
		return f(ctx, mv)
	}
...
// The SettingHistoryFunc type is an adapter to allow the use of ordinary
// function as SettingHistory mutator.
type SettingHistoryFunc func(context.Context, *ent.SettingHistoryMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f SettingHistoryFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.SettingHistoryMutation); ok {
		return f(ctx, mv)
	}
...
// The TrafficPolicyFunc type is an adapter to allow the use of ordinary
// function as TrafficPolicy mutator.
type TrafficPolicyFunc func(context.Context, *ent.TrafficPolicyMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f TrafficPolicyFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.TrafficPolicyMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.TrafficPolicyMutation", m)
}
