...
func (*Project) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case project.FieldName, project.FieldDescription, project.FieldStatus, project.FieldNodeID, project.FieldApplicationID:
			values[i] = new(sql.NullString)
		case project.FieldCreatedAt, project.FieldUpdatedAt:
			values[i] = new(sql.NullTime)
		case project.FieldID, project.FieldTenantID, project.FieldTemplateID:
...
func (pr *Project) String() string {
	...
	builder.WriteString(fmt.Sprintf("%v", pr.TemplateID))
	builder.WriteString(", ")
	...
	builder.WriteString(pr.ApplicationID)
	builder.WriteString(", ")
