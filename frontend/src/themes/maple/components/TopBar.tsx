// maple 扁平顶栏：白底细边框、直角按钮与下拉面板，无投影。
      ...
      <div className="ml-auto flex items-center gap-2">
        ...
        <div className="relative" ref={langRef}>
          <button
            ...
            className="flex items-center gap-1 px-2 py-1.5 text-sm text-slate-600 transition-colors hover:bg-slate-100 dark:text-slate-300 dark:hover:bg-slate-800"
          ...
          {langOpen && (
            <div
              className="absolute right-0 top-full z-50 mt-1 w-32 border border-slate-200 bg-white py-1 dark:border-slate-700 dark:bg-slate-800"
        ...
        <button
          onClick={toggleMode}
          className="flex items-center p-2 text-slate-600 transition-colors hover:bg-slate-100 dark:text-slate-300 dark:hover:bg-slate-800"
        ...
        {admin && (
          <div className="relative" ref={userRef}>
            <button
              ...
              className="flex items-center gap-2 px-2 py-1.5 text-sm text-slate-700 transition-colors hover:bg-slate-100 dark:text-slate-200 dark:hover:bg-slate-800"
            >
              <span className="flex h-7 w-7 items-center justify-center bg-th-accent-soft-bg text-xs font-semibold text-th-accent-soft-text">
            ...
            {userOpen && (
              <div
                className="absolute right-0 top-full z-50 mt-1 w-52 border border-slate-200 bg-white py-1 dark:border-slate-700 dark:bg-slate-800"
